                        ...
                        <BlankCard>
                            <CardContent sx={{ p: '32px' }}>
                                ...
                                <Stack mt={4} direction="row" gap="8px" alignItems="end">
                                    <Typography variant='h4' fontSize="40px" color='primary.main' fontWeight={700}>${license.price}</Typography>
                                ...
                                {license.isPopular ?
                                    ...
                                    :
                                    <Button fullWidth variant="contained" color='secondary' size="large">Purchase Now</Button>
                                }
                            </CardContent>
                        </BlankCard>
                    </Grid>
